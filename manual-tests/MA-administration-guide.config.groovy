outputPath = 'build/MA-administration-guide'

// Path where the docToolchain will search for the input files.
// This path is appended to the docDir property specified in gradle.properties
// or in the command line, and therefore must be relative to it.

inputPath = 'MA-administration-guide';
...
confluence = [
    ...
    input: [
            [ file: "build/MA-administration-guide/html5/index.html" ],
    ],
    ...
    preambleTitle: "${scmref} - Manuel d'Administration",
...
openApi.with {
    specFile = 'docs/petstore-v2.0.yaml' // i.e. 'petstore.yaml', 'src/doc/petstore.yaml'
